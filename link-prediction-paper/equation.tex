...
Using the optimal parameters from the previous section, we run SGD with DSGD to
compare results between pure and hybrid matrix factorization. For comparison purposes, we again use DSGD as it has a more deterministic update routine which allows us to fairly limit the number of iterations for both formulations.}
